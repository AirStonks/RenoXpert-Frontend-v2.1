...
const routeCat: { path: string; element: JSX.Element; layout?: React.FC<ProtectedLayoutProps> | null }[][] = [
    ...
    [
        ...
        { path: '/packages/create', element: <StaffRestrictedRoute><CreatePackage /></StaffRestrictedRoute>, layout: ProtectedLayout },
        { path: '/packages/:id', element: <PackageDetail />, layout: ProtectedLayout },
        { path: '/packages/edit/:id', element: <StaffRestrictedRoute><EditPackage /></StaffRestrictedRoute>, layout: ProtectedLayout },
    ...
    [
        ...
        { path: '/campaigns/:campaignSlug/faq', element: <FAQPage />, layout: null },
...
const routeCatLocal: { path: string; element: JSX.Element; layout?: React.FC<ProtectedLayoutProps> | null }[][] = [
    ...
    [
        ...
        { path: '/staff/packages/create', element: <StaffRestrictedRoute><CreatePackage /></StaffRestrictedRoute>, layout: ProtectedLayout },
        { path: '/staff/packages/:id', element: <PackageDetail />, layout: ProtectedLayout },
        { path: '/staff/packages/edit/:id', element: <StaffRestrictedRoute><EditPackage /></StaffRestrictedRoute>, layout: ProtectedLayout },
    ...
    [
        ...
        { path: '/campaign/campaigns/:campaignSlug/faq', element: <FAQPage />, layout: null },
