...
function QuotationDetailModal({ quotationId, onClose }: QuotationDetailModalProps) {
    ...
    useEffect(() => {
        ...
        // Extract metadata to localStorage
    ...
    if (loading) {
        ...
        const metadataArray = Object.values(quotationDetail.metadata);
        setSelectedPackages(metadataArray);
                    ...
                    <div className="card">
                        <div className="card-header flex justify-between items-center">
                            ...
                            <button
                                ...
                                data-action="edit"
                                data-id={quotationId}
                                data-modal-toggle="#edit_quotation_modal"
                            >
                    ...
                    <div className="card">
                        ...
                        {/* <div className="card-table pb-3.5">
                            <table className="table align-middle text-gray-700 font-medium text-sm">
                                <thead>
                                    <tr>
                                        <th className='w-[150px]'>Package</th>
                                        <th className='w-[100px] text-center'>Quantity</th>
                                        <th className='w-[100px]'>Unit Price</th>
                                        <th className='w-[100px]'>Total Price</th>
                                    </tr>
