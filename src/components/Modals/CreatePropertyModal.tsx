...
function CreatePropertyModal() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (response?.success) {
                ...
                // Close Modal
                const element = document.querySelector('#create_property_modal') as HTMLElement;
    ...
    return (
        <div className="modal p-14" data-modal="true" data-modal-backdrop-static="true" id="create_property_modal">
            <div className="modal-content modal-center-y max-w-[600px] max-h-[95%]">
                <div className="modal-header py-4 px-5">
                    <span className="text-lg text-gray-900 font-bold">Add New Property</span>
                    <button
