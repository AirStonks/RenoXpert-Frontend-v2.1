...
import { ArrowLeft, Calculator, Calendar, DollarSign, Clock, TrendingUp } from "lucide-react"
            ...
            try {
                ...
                if (response?.success) {
                    ...
                    setFormData((prev) => ({
                        ...
                        is_addon_included: data.is_addon_included || false,
                        quantity: data.quantity || 0,
                        markupAmount: data.markup_amount || 0,
                        markupPercentage: data.markup_percentage ? data.markup_percentage * 100 : 0,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (error.response?.status === 422) {
                ...
                notify("error", "Package creation unsuccessful. Check the errors below.")
            } else {
            ...
            <div className="bg-white/80 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-10">
                <div className="px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">Create New Package</h1>
                            <p className="text-sm text-gray-600">Build and configure your package details</p>
                        </div>
                    </div>
                </div>
            </div>
