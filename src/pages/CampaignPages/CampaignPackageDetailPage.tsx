            ...
            <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200/50 sticky top-0 z-40">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-xs text-gray-500">Campaign package detail</div>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-200 shadow-lg overflow-hidden">
                        <div className="p-6 sm:p-8">
                            ...
                            {selectedCampaignPackage?.description && (
                                <p className="text-xs mt-4 text-gray-600 leading-relaxed whitespace-pre-line">{selectedCampaignPackage.description}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl border border-gray-200 shadow-lg overflow-hidden">
                    <div className="px-6 sm:px-8 pt-6 sm:pt-8">
                        <div className="flex gap-2 bg-white">
                            <button
                                className={`py-2 text-xs px-3 rounded-md transition-all ${activeTab === 'quotation' ? 'active bg-blue-500 text-white' : 'hover:bg-gray-100'
                                    }`}
                            ...
                            <button
                                className={`py-2 text-xs px-3 rounded-md transition-all ${activeTab === 'tnc' ? 'active bg-blue-500 text-white' : 'hover:bg-gray-100'
                                    }`}
                    ...
                    {activeTab === 'tnc' ? (
                        <div className="prose max-w-none p-6 sm:p-8 text-xs">{tnc}</div>
                    ) : (
                        <div className="p-6 sm:p-8 space-y-6">
                            {!selectedCampaignPackage ? (
                                <div className="p-8 text-center">
                                    ...
                                    <p className="mt-2 text-gray-600">This campaign package doesn&apos;t exist.</p>
                                </div>
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    <p className="mt-2 text-gray-600">This campaign package doesn&apos;t have a linked template order yet.</p>
                                </div>
                            ) : (
                                <>
                                    {/* Payment Summary */}
                                                ...
                                                <div className="flex flex-col items-start w-full">
                                                    ...
                                                    <div className="flex justify-between w-full">
                                                        <p className="italic text-gray-600 text-xs flex items-center">
                                                            ...
                                                            <button className="mx-1" onClick={() => setActiveTab('tnc')} type="button">
                                                ...
                                                <div className="flex flex-col items-start w-full">
                                                    <p className="text-lg text-[#d71e42] font-bold">
                                                        <span className="text-sm text-gray-600">
                                                            Kickstart <span className="text-lg text-[#d71e42] font-bold">NOW</span> by just paying{' '}
                                                        </span>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div className="text-left flex-1">
                                                                {isAddon && <div className="text-xs font-bold text-blue-700 mb-1">Optional Add-on Package</div>}
                                                                <div className="text-sm font-semibold text-gray-900">{pkg.name || 'Package'}</div>
                                                                <div className="text-xs text-gray-600 mt-1">{products.length} item(s)</div>
                                                            </div>
                                                            {expanded ? (
                                                        ...
                                                        {expanded && (
                                                            <div className="p-4 sm:p-5 bg-white">
                                                                {pkg.description && <p className="text-xs text-gray-600 mb-4 whitespace-pre-line">{pkg.description}</p>}
                                                                                ...
                                                                                {products.map((p) => (
                                                                                    <tr key={String(p.id)} className="border-b last:border-b-0">
                                                                                        <td className="py-3 pr-4">
                                                                                            ...
                                                                                            {p.description && <div className="text-2xs text-gray-500 mt-1 line-clamp-2">{p.description}</div>}
                                                                                        </td>
                                                                                        <td className="text-xs py-3 px-3 text-center">
