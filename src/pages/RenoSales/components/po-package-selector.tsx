...
export function POPackageSelector({ isOpen, onClose, selectedPackages, onSelectPackage, onRemovePackage }: PackageSelectorProps) {
    ...
    const calculateTotalCogs = (pkg: Package) => {
        return pkg.products.reduce((total, product) => total + ((product.provisioning.install.cogs + product.provisioning.supply.cogs) * product.pivot.quantity), 0);
    };
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-gray-200/50 shrink-0">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Choose packages to add to PO</p>
                        </div>
                                ...
                                {packages.map((pkg, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col space-y-4">
                                            <div className="text-xl font-bold text-gray-900">RM {calculateTotalCogs(pkg).toLocaleString()}</div>
