                    ...
                    <div className={activeTab === 'tab_1_1' ? '' : 'hidden'} id="tab_1_1">
                        <div className="overflow-x-auto">
                            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 mb-4">
                                <div className="card flex-1 sm:mb-0">
                                    ...
                                    <div className="card-body">
                                        <div className="flex flex-col mb-4">
                                            ...
                                            <span className='text-sm text-gray-900'>{orderDetail.order_no}</span>
                                        </div>
                                        <div className="flex flex-col mb-4">
                                            <span className='text-sm text-gray-600'>Total Amount:</span>
                                            <span className='text-sm text-gray-900'>{`RM ${orderDetail.total_amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}</span>
                                        </div>
                                        <div className="flex flex-col">
                                ...
                                <div className="card flex-1 sm:mb-0">
                                    ...
                                    <div className="card-body">
                                        <div className="flex flex-col mb-4">
                                            ...
                                            <span className='text-sm text-gray-900'>{orderDetail.property.name}</span>
                                        </div>
                                        <div className="flex flex-col mb-4">
                                            <span className='text-sm text-gray-600'>Unit:</span>
                                            <span className='text-sm text-gray-900'>{orderDetail.block}-{orderDetail.floor}-{orderDetail.unit_no}</span>
                                        </div>
                                        <div className="flex flex-col">
                                ...
                                <div className="card flex-1 sm:mb-0">
                                    ...
                                    <div className="card-body">
                                        <div className="flex flex-col mb-4">
                                            ...
                                            <span className='text-sm text-gray-900'>{orderDetail.contact.name}</span>
                                        </div>
                                        <div className="flex flex-col mb-4">
                                            <span className='text-sm text-gray-600'>Email:</span>
                                            <span className='text-sm text-gray-900'>{orderDetail.contact.email}</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className='text-sm text-gray-600'>Phone No.:</span>
                                            <span className='text-sm text-gray-900'>{orderDetail.contact.phone_no}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
