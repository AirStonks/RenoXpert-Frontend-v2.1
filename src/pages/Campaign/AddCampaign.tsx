...
export default function AddCampaign() {
    ...
    // Reorder LAYOUT TYPES: arrayMove layoutTypes, rebuild layout-index-keyed maps, AND remap
    ...
    // Drag-end handler for the flat (no-layout) package list — ids map back to absolute indices.
    ...
    // Drag-end handler for packages WITHIN one layout's sub-list — map within-group ids to
    // absolute `packages` indices, then reorder the absolute array (descriptors carry layoutIdx,
    // so grouping by packageLayoutIndex still renders correctly).
